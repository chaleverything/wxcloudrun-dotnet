...
{
    public class ControllerExtends
    {
        ...
        public ControllerExtends(IGoodsService goodsService,
        ...
        /// GetGoodsDetail
        /// </summary>
        /// <param name="lstGoods"></param>
        /// <param name="result"></param>
        /// <returns></returns>
        public async Task<ResultList<GoodsInfo>> GetGoodsDetail(List<GoodsDto> lstGoods, ResultList<GoodsInfo> result)
        {
